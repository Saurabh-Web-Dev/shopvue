<template>
    <div class="wrapper">
        <div class="inner">
            <img src="../../../../public/images/image-1.png" alt="" class="image-1">
            ...
            <Form @submit="register" :validation-schema="schema">
                ...
                <div class="form-holder">
                    ...
                    <Field type="text" class="form-control" name="name" placeholder="Name" spellcheck="false" data-ms-editor="true"/>
                    <ErrorMessage class="text-danger" name="name" as="div" />
                </div>
                <div class="form-holder">
                    <span class="fa fa-phone"></span>
                    <Field type="tel" class="form-control" name="phone" placeholder="Phone Number" spellcheck="false" data-ms-editor="true"/>
                    <ErrorMessage class="text-danger" name="phone" as="div" />
                </div>
                <div class="form-holder">
                    <span class="fa fa-envelope"></span>
                    <Field type="text" class="form-control" name="email" placeholder="Email" spellcheck="false" data-ms-editor="true"/>
                ...
                <div class="form-holder">
                    <span class="fa fa-lock"></span>
                    <Field type="password" class="form-control" name="cpassword" placeholder="Confirm Password"/>
                    <ErrorMessage class="text-danger" name="cpassword" as="div" />
                </div>
                <button type="submit">
                    <span>Register</span>
                </button>
            ...
            <img src="../../../../public/images/image-2.png" alt="" class="image-2">
        </div>
...
export default {
    ...
    data() {
        const schema = yup.object({
            ...
            cpassword: yup.string().required('Confirm Password is required').oneOf([yup.ref('password'), null], 'Passwords must match').min(6)
        });
