<template>
    ...
    <div class="product_section layout_padding">
        <div class="container">
            ...
            <div class="product_section_2 layout_padding">
                ...
                <div class="seemore_bt"><router-link to="/products">See More</router-link></div>
            </div>
        </div>
    </div>
    <!-- product section end -->
        ...
        <div class="container">
            <div class="about_section_main">
                <div class="row">
                    ...
                    <div class="col-md-6">
                    <div><img src="../../../public/images/about-img.png" class="image_3"></div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <ContactSectionWithMap></ContactSectionWithMap>
    <!-- contact section end -->
...
import ContactSectionWithMap from "./ContactSection.vue";
